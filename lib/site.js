export const site = {
  ...
  descricao:
    'Clínica em Porto Velho: exames ocupacionais com ASO no mesmo dia para empresas, e atendimento clínico particular para a sociedade.',
  email: 'adm@agilmedocupacional.com.br',
  telefone: '(69) 99610-3879',
  telefoneRaw: '5569996103879',
  instagram: 'https://www.instagram.com/agilmedocupacional',
  portalUrl: 'https://portal-cliente-agilmed-reallife.vercel.app',
  endereco: {
  ...
  responsavelTecnico: {
    ...
    especialidade: 'Diretora Técnica',
  },
};
    ...
    colunas: [
      {
        ...
        itens: [
          { href: '/para-empresas', rotulo: 'Exames para empresas', nota: 'Como a clínica atende o seu RH' },
          { href: '/boletim', rotulo: 'Boletim de Antecedência', nota: 'Os exames que vencem nos próximos 90 dias' },
          { href: '/agendamento', rotulo: 'Agendar em lote', nota: 'Horário reservado para contratação em volume' },
        ],
      },
      {
...
export const rodapeLinks = [
  ...
  },
  {
    ...
    itens: [
      ...
      { href: '/exames-clinicos', rotulo: 'ECG, EEG e audiometria' },
      { href: '/exames-laboratoriais-porto-velho', rotulo: 'Exames laboratoriais' },
      { href: '/para-voce/fisioterapia', rotulo: 'Fisioterapia' },
      { href: '/para-voce/psicologia', rotulo: 'Psicologia' },
      { href: '/para-voce/nutricao', rotulo: 'Nutrição' },
    ],
  },
  {
    titulo: 'ÁgilMed',
...
export const realLife = {
  nome: 'Real Life Engenharia de SSMA',
  url: 'https://www.reallifessma.com.br',
  faz: 'PGR, PCMSO, laudos, eSocial SST e treinamentos',
};
