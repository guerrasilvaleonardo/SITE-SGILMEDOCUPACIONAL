...
export const navegacao = [
  {
    ...
    itens: [
      ...
      { href: '/exames-clinicos', rotulo: 'Exames clínicos', nota: 'ECG, EEG, audiometria e coleta laboratorial' },
      { href: '/para-voce/fisioterapia', rotulo: 'Fisioterapia', nota: 'Reabilitação, dor e recuperação de movimento' },
      ...
      { href: '/equipe', rotulo: 'Nossa equipe', nota: 'Quem vai atender você, com nome e registro' },
    ],
  },
  {
